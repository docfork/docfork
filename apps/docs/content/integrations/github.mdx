...
Connect GitHub in the Integrations dashboard to index and search documentation from your private repositories. Your agent can then use that documentation via [Cabinets](/core/cabinets) and `search_docs`.
